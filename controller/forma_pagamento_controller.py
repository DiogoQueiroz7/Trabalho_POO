...
class FormaPagamentoController:
    ...
    def criar_pix(self, chave_pix: str) -> Pix | None: #
        """
    ...
    def criar_cartao_credito(self, numero_cartao: str, nome_titular: str,
                             data_validade: str, codigo_seguranca: str) -> CartaoCredito | None: #
        ...
        if not novo_cartao.ultimos_digitos or not novo_cartao.nome_titular or not novo_cartao.data_validade: 
            ...
            print("Erro: Dados essenciais do cartão de crédito parecem inválidos ou incompletos. Não será salvo.")
            return None
    ...
    def criar_boleto(self, codigo_barras: str) -> Boleto | None: 
        """
        ...
        if not novo_boleto.codigo_barras: 
            print("Erro: Código de barras do boleto parece inválido. Não será salvo.")
            return None
    ...
    def listar_todas_formas_pagamento(self) -> list[FormaPagamento]: 
    ...
    def buscar_forma_pagamento_por_id(self, id_fp: int) -> FormaPagamento | None: 
